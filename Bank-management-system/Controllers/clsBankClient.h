...
private:
    ...
    static stTrnsferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TrnsferLogRecord.Amount = stof(vTrnsferLogRecordLine[3]);
        TrnsferLogRecord.srcBalanceAfter = stof(vTrnsferLogRecordLine[4]);
        TrnsferLogRecord.destBalanceAfter = stof(vTrnsferLogRecordLine[5]);
